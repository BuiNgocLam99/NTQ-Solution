...
@section('title')
Admin\Create Product | NTQ-Solution
@endsection
...
<div id="removeNotificationModal" class="modal fade zoomIn" tabindex="-1" aria-hidden="true">
                    ...
                    <form id="myForm" method="POST">
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="product-title-input" name="product_title" value="" placeholder="Enter product title" required>
                                            <span id="product_title_error" class="text-danger"></span>
                                        </div>
                                        <div>
                                            <label>Product Description</label>
                                            <textarea id="ckeditor-classic" name="product_description"></textarea>
                                            ...
                                            <div class="text-center">
                                                <div class="position-relative d-inline-block">
                                                    <div class="position-absolute top-100 start-100 translate-middle">
                                                        ...
                                                        <input class="form-control d-none" value="" id="product-image-input" name="product_thumbnail" type="file" accept="image/png, image/jpg, image/jpeg">
                                                    </div>
                                                    <div class="avatar-lg">
                                                    ...
                                                    <span id="product_thumbail_error" class="text-danger"></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div>
                                            ...
                                            <div class="dropzone">
                                                <div class="fallback">
                                                    <input name="product_images" type="file" multiple="multiple" accept="image/png, image/jpg, image/jpeg">
                                                </div>
                                            ...
                                            <span id="product_images_error" class="text-danger"></span>
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group has-validation mb-3">
                                                ...
                                                <input type="text" class="form-control" id="product-price" name="product_price" placeholder="Enter price" aria-label="Price" aria-describedby="product-price-addon" required>
                                                <span id="product_price_error" class="text-danger"></span>
                                            </div>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label" for="product-quantity">Quantity</label>
                                            <input type="text" class="form-control" id="product-quantity" name="product_quantity" placeholder="Quantity" required>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <ul id="nav-items" class="nav nav-tabs-custom card-header-tabs border-bottom-0" role="tablist">
                                            <li class="nav-item">
                                        ...
                                        <div id="tab-panes" class="tab-content">
                                            <div class="tab-pane active" id="addproduct-general-info" role="tabpanel">
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label class="form-label" for="manufacturer-name-input">Color</label>
                                                            <select class="form-select" id="colorSelect" name="product_status" data-choices data-choices-search-false multiple>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label class="form-label" for="manufacturer-brand-input">Size</label>
                                                            <select class="form-select" id="sizeSelect" name="product_status" data-choices data-choices-search-false multiple>
                                                    ...
                                                    <div class="text-start mb-3">
                                                        <button type="button" id="btn-create-variations" class="btn btn-info w-sm">Create Variations</button>
                                                    </div>
                                                </div>
                                                <div id="variation-colors" class="d-flex flex-wrap justify-content-around"></div>
                                            </div>
                                        </div>
                                        <!-- end tab content -->
                                    </div>
                            ...
                            <div class="col-lg-4">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="choices-publish-status-input" name="product_status" data-choices data-choices-search-false>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <label for="choices-publish-status-input" class="form-label">Shop</label>

                                            <select class="form-select" id="choices-publish-status-input" name="product_shop" data-choices data-choices-search-false>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="choices-publish-status-input" name="product_category" data-choices data-choices-search-false>
    ...
    <!-- Theme Settings -->
    {{-- <div class="offcanvas offcanvas-end border-0" tabindex="-1" id="theme-settings-offca nvas">
...
<script src="{{ asset('admin/product/script.js') }}"></script>
<script>
    $(document).ready(function(){
        ...
        $(this).find('input[name^="product_"], select[name^="product_"]').each(function(){
            var input = $(this);
        ...
        if ($('div[id*="tab-pane_"]').length) {
            
            $('div[id*="tab-pane_"]').each(function(index){
                
                var inputFile = $(this).find(':file');
                formData.append(inputFile.attr('id'), inputFile[0].files[0]);
                
                $('div[id*="product_"]').each(function(index ){
                    var variation = {};
                    $(this).find('input').each(function() {
                        variation[$(this).attr('name')] = $(this).val();
                    });
                    formData.append($(this).attr('id'), JSON.stringify(variation)); 
                });
            })
        } 
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success_message) {
                    $('#message').addClass('card-title text-success text-center').text(response.success_message);
